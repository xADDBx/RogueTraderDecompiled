...
public class GamePadInputModule : BaseInputModule
{
	...
	public override bool ShouldActivateModule()
	{
		...
		return true | Input.GetButtonDown(m_SubmitButton) | Input.GetButtonDown(m_CancelButton) | !Mathf.Approximately(Input.GetAxisRaw(m_HorizontalAxis), 0f) | !Mathf.Approximately(Input.GetAxisRaw(m_VerticalAxis), 0f);
	}
