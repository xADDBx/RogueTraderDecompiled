...
internal class UnitySourceGeneratedAssemblyMonoScriptTypes_v1
{
	...
	private static MonoScriptData Get()
	{
		...
		result.FilePathsData = new byte[78]
		{
			0, 0, 0, 1, 0, 0, 0, 70, 92, 76,
			105, 98, 114, 97, 114, 121, 92, 80, 97, 99,
			107, 97, 103, 101, 67, 97, 99, 104, 101, 92,
			99, 111, 109, 46, 111, 119, 108, 99, 97, 116,
			46, 118, 105, 115, 117, 97, 108, 64, 49, 46,
			49, 46, 50, 50, 53, 92, 83, 104, 97, 100,
			101, 114, 76, 105, 98, 114, 97, 114, 121, 92,
			68, 117, 109, 109, 121, 46, 99, 115
		};
