...
[TypeId("4d40d90314f047f43be3e775f6a8a3b5")]
public class PrerequisiteObsoleteProficiency : Prerequisite_Obsolete
{
	...
	public override string GetUIText(BaseUnitEntity unit)
	{
		...
		stringBuilder.Append($"{UIStrings.Instance.Tooltips.HasProficiencies}:\n");
