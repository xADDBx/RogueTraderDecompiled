...
public static class PartMechanicFeaturesExtension
{
	...
	public static FeatureCountableFlag GetMechanicFeature(this MechanicEntity entity, MechanicsFeatureType type)
	{
		...
		return type switch
		{
			...
			MechanicsFeatureType.UnconsciousOnZeroHealth => features.UnconsciousOnZeroHealth, 
			...
			MechanicsFeatureType.DisableAttacksOfOpportunityForShield => features.DisableAttacksOfOpportunityForShield, 
			...
			MechanicsFeatureType.ProvidesHalfCover => features.ProvidesHalfCover, 
			...
			MechanicsFeatureType.OldInjuryImmunity => features.OldInjuryImmunity, 
			...
			MechanicsFeatureType.DeadCountedForAI => features.DeadCountedForAI, 
