...
public sealed class UnitActivateAbilityParams : UnitCommandParams<UnitActivateAbility>, IMemoryPackable<UnitActivateAbilityParams>, IMemoryPackFormatterRegister
{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitActivateAbilityParams? value)
	{
		...
		if (memberCount == 20)
		{
			EntityFactRef<ActivatableAbility> value21;
			if (value != null)
			{
				value2 = value.Type;
			...
			value21 = reader.ReadPackable<EntityFactRef<ActivatableAbility>>();
		}
		else
		{
			if (memberCount > 20)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitActivateAbilityParams), 20, memberCount);
				return;
			}
			EntityFactRef<ActivatableAbility> value21;
			if (value == null)
			{
				...
				value19 = null;
				value20 = null;
				value21 = default(EntityFactRef<ActivatableAbility>);
			}
			else
			{
				value2 = value.Type;
