...
public sealed class UnitMoveToParams : UnitCommandParams<UnitMoveTo>, IMemoryPackable<UnitMoveToParams>, IMemoryPackFormatterRegister
{
	...
	public static void Serialize(ref MemoryPackWriter writer, ref UnitMoveToParams? value)
	{
		...
		writer.WriteUnmanagedWithObjectHeader(23, in value.Type);
		...
		value6 = value.Orientation;
		value3 = value.RunAway;
		value4 = value.Roaming;
		writer.DangerousWriteUnmanaged(in movementType, in isOneFrameCommand, in slowMotionRequired, in approachRadiusForAgentASP, in value6, in value3, in value4);
	}
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitMoveToParams? value)
	{
		...
		if (memberCount == 23)
		{
			if (value != null)
			{
				...
				value21 = value.ApproachRadiusForAgentASP;
				value22 = value.Orientation;
				value23 = value.RunAway;
				value24 = value.Roaming;
				...
				reader.DangerousReadUnmanaged<float?>(out value22);
				reader.ReadUnmanaged<bool>(out value23);
				reader.ReadUnmanaged<bool>(out value24);
				goto IL_04bc;
			}
			reader.ReadUnmanaged<CommandType>(out value2);
			...
			reader.DangerousReadUnmanaged<WalkSpeedType?, bool?, bool?, float, float?, bool, bool>(out value18, out value19, out value20, out value21, out value22, out value23, out value24);
		}
		else
		{
			if (memberCount > 23)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitMoveToParams), 23, memberCount);
				return;
			}
			if (value == null)
			{
		...
		value = new UnitMoveToParams
		{
			...
			ApproachRadiusForAgentASP = value21,
			Orientation = value22,
			RunAway = value23,
			Roaming = value24
		};
		...
		value.ApproachRadiusForAgentASP = value21;
		value.Orientation = value22;
		value.RunAway = value23;
		value.Roaming = value24;
	}
}
