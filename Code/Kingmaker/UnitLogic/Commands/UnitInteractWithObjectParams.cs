...
public sealed class UnitInteractWithObjectParams : UnitCommandParams<UnitInteractWithObject>, IMemoryPackable<UnitInteractWithObjectParams>, IMemoryPackFormatterRegister
{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitInteractWithObjectParams? value)
	{
		...
		bool? value19;
		bool? value20;
		ViewBasedPartRef<MapObjectEntity, InteractionPart> value21;
		ViewBasedPartRef<MapObjectEntity, ViewBasedPart> value22;
		if (memberCount == 21)
		{
			if (value != null)
			{
				...
				value21 = value.m_Interaction;
				value22 = value.m_VariantActor;
			...
			value21 = reader.ReadPackable<ViewBasedPartRef<MapObjectEntity, InteractionPart>>();
			value22 = reader.ReadPackable<ViewBasedPartRef<MapObjectEntity, ViewBasedPart>>();
		}
		else
		{
			if (memberCount > 21)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitInteractWithObjectParams), 21, memberCount);
				return;
			}
			if (value == null)
			{
				...
				value19 = null;
				value20 = null;
				value21 = default(ViewBasedPartRef<MapObjectEntity, InteractionPart>);
				value22 = default(ViewBasedPartRef<MapObjectEntity, ViewBasedPart>);
			}
			else
			{
				value2 = value.Type;
		...
		value = new UnitInteractWithObjectParams
		{
			...
			m_Interaction = value21,
			m_VariantActor = value22
		};
		return;
		IL_046b:
		value.Type = value2;
		...
		value.m_Interaction = value21;
		value.m_VariantActor = value22;
	}
}
