...
public sealed class UnitInteractWithUnitParams : UnitCommandParams<UnitInteractWithUnit>, IMemoryPackable<UnitInteractWithUnitParams>, IMemoryPackFormatterRegister
{
	...
	public static void Serialize(ref MemoryPackWriter writer, ref UnitInteractWithUnitParams? value)
	{
		...
		EntityRef<AbstractUnitEntity> value7 = value.TargetUnit;
		writer.WritePackable(in value7);
	}
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitInteractWithUnitParams? value)
	{
		...
		bool? value14;
		bool? value15;
		EntityRef<AbstractUnitEntity> value16;
		if (memberCount == 15)
		{
			if (value != null)
			{
			...
			value16 = reader.ReadPackable<EntityRef<AbstractUnitEntity>>();
		}
		else
		{
			if (memberCount > 15)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitInteractWithUnitParams), 15, memberCount);
				return;
			}
			if (value == null)
			{
				...
				value14 = null;
				value15 = null;
				value16 = default(EntityRef<AbstractUnitEntity>);
			}
			else
			{
				value2 = value.Type;
