...
public sealed class UnitDoNothingParams : UnitCommandParams<UnitDoNothing>, IMemoryPackable<UnitDoNothingParams>, IMemoryPackFormatterRegister
{
	[Preserve]
	private sealed class UnitDoNothingParamsFormatter : MemoryPackFormatter<UnitDoNothingParams>
	{
		[Preserve]
		public override void Serialize(ref MemoryPackWriter writer, ref UnitDoNothingParams value)
		{
	...
	[Preserve]
	public static void Serialize(ref MemoryPackWriter writer, ref UnitDoNothingParams? value)
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitDoNothingParams? value)
	{
		...
		if (memberCount == 15)
		{
			...
			reader.DangerousReadUnmanaged<WalkSpeedType?, bool?, bool?, float>(out value13, out value14, out value15, out value16);
		}
		else
		{
			if (memberCount > 15)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitDoNothingParams), 15, memberCount);
				return;
			}
			if (value == null)
			{
