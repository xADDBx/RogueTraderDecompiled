...
public sealed class UnitMoveAlongPathParams : UnitCommandParams<UnitMoveAlongPath>, IMemoryPackable<UnitMoveAlongPathParams>, IMemoryPackFormatterRegister
{
	[Preserve]
	private sealed class UnitMoveAlongPathParamsFormatter : MemoryPackFormatter<UnitMoveAlongPathParams>
	{
		[Preserve]
		public override void Serialize(ref MemoryPackWriter writer, ref UnitMoveAlongPathParams value)
		{
			UnitMoveAlongPathParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void Deserialize(ref MemoryPackReader reader, ref UnitMoveAlongPathParams value)
		{
			UnitMoveAlongPathParams.Deserialize(ref reader, ref value);
		}
	}

	[JsonConstructor]
	[MemoryPackConstructor]
	public UnitMoveAlongPathParams()
		: base(default(JsonConstructorMark))
	{
	}

	public UnitMoveAlongPathParams([NotNull] ForcedPath path)
	{
	...
	public UnitMoveAlongPathParams([NotNull] List<Vector3> points)
		: this(ForcedPath.Construct(points))
	{
	}

	static UnitMoveAlongPathParams()
	{
		RegisterFormatter();
	}
	...
	{
		if (!MemoryPackFormatterProvider.IsRegistered<UnitMoveAlongPathParams>())
		{
			MemoryPackFormatterProvider.Register(new UnitMoveAlongPathParamsFormatter());
		}
		if (!MemoryPackFormatterProvider.IsRegistered<UnitMoveAlongPathParams[]>())
		{
			MemoryPackFormatterProvider.Register(new ArrayFormatter<UnitMoveAlongPathParams>());
		}
	...
	[Preserve]
	public static void Serialize(ref MemoryPackWriter writer, ref UnitMoveAlongPathParams? value)
	{
		if (value == null)
		{
	...
	[Preserve]
	public static void Deserialize(ref MemoryPackReader reader, ref UnitMoveAlongPathParams? value)
	{
		...
		else
		{
			if (memberCount > 14)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitMoveAlongPathParams), 14, memberCount);
				return;
			}
			if (value == null)
			{
		...
		value = new UnitMoveAlongPathParams
		{
			Type = value2,
			OwnerRef = value3,
			Target = value4,
