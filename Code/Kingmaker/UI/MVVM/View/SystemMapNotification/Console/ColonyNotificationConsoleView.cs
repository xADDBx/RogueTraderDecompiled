...
public class ColonyNotificationConsoleView : BaseSystemMapNotificationConsoleView<ColonyNotificationVM>
{
	protected override void InitializeImpl()
	{
		m_ActionHint.SetLabel(UIStrings.Instance.ColonyNotificationTexts.ColonyManagementButtonText.Text);
	}
