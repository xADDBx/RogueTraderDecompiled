...
public class RankEntryFeatureSelectionConsoleView : BaseCareerPathSelectionTabConsoleView<RankEntrySelectionVM>
{
	...
	protected override void BindViewImplementation()
	{
		...
		{
			SetNextButtonLabel(canCommit ? UIStrings.Instance.CharacterSheet.ToSummaryTab : UIStrings.Instance.CharGen.Next);
	...
	private void CreateNavigation()
	{
		...
		{
			m_Navigation.AddEntityVertical(m_FeaturesFilter.GetNavigation());
		}
	...
	{
		GridConsoleNavigationBehaviour navigation = m_Navigation;
		if (navigation != null && !navigation.IsFocused)
		{
			EventBus.RaiseEvent(delegate(IRankEntryFocusHandler h)
			{
				h.SetFocusOn(null);
