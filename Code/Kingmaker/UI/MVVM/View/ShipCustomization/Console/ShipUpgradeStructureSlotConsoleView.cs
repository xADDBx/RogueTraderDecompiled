...
public class ShipUpgradeStructureSlotConsoleView : ShipUpgradeStructureSlotPCView, IConfirmClickHandler, IConsoleEntity, IFloatConsoleNavigationEntity, IConsoleNavigationEntity
{
	[SerializeField]
	...
	protected override void BindViewImplementation()
	{
		...
		AddDisposable(m_MultiButton.SetTooltip(base.ViewModel.ShipInternalStructureTooltip));
