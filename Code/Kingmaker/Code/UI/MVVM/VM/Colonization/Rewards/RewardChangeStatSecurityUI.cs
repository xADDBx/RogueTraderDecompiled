...
public class RewardChangeStatSecurityUI : RewardUI<RewardChangeStatSecurity>
{
	public override string Name => string.Empty;

	public override string Description => UIStrings.Instance.ColonyProjectsRewards.RewardChangeStatSecurity.Text;

	public override Sprite Icon => BlueprintRoot.Instance.UIConfig.UIIcons.Security;

	public override string NameForAcronym => null;

	public override int Count => base.Reward.SecurityModifier;

	public override string CountText => base.Reward.SecurityModifier.ToString("+#;-#;0");
	...
	public RewardChangeStatSecurityUI(RewardChangeStatSecurity reward)
		: base(reward)
	{
	}
