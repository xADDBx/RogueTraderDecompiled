...
public class RequirementResourceUseOrderUI : RequirementUI<RequirementResourceUseOrder>
{
	...
	public RequirementResourceUseOrderUI(RequirementResourceUseOrder requirement)
		: base(requirement)
	{
	}
