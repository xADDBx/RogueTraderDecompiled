...
public class GroupChangerContextVM : BaseDisposable, IViewModel, IBaseDisposable, IDisposable, IGroupChangerHandler, ISubscriber, IDetachUnitsUIHandler
{
	...
	public void HandleCall(Action goAction, Action closeAction, bool isCapital)
	{
		...
		{
			GroupChangerVM disposable = (GroupChangerVm.Value = new GroupChangerCommonVM(goAction, closeAction, m_LastUnits, m_RequiredUnits, isCapital));
