...
namespace Kingmaker.Code.UI.MVVM.View.Settings.PC.KeyBindSetupDialog;

public class KeyBindingSetupDialogPCView : ViewBase<KeyBindingSetupDialogVM>
{
	[SerializeField]
	...
	private void Show()
	{
		if (!m_IsShowed)
		{
			...
			UISounds.Instance.Sounds.Settings.SettingsKeyBindingOpen.Play();
		}
	}
	...
	public void Hide()
	{
		if (m_IsShowed)
		{
			...
			UISounds.Instance.Sounds.Settings.SettingsKeyBindingClose.Play();
		}
	}
	...
	private KeyBindingData GetTempBinding()
	{
		...
		if (Input.anyKey && !Input.GetMouseButton(0) && !Input.GetMouseButton(1))
		{
			...
			{
				if (Input.GetKey(value) && value != KeyCode.LeftShift && value != KeyCode.RightShift && value != KeyCode.LeftAlt && value != KeyCode.RightAlt && value != KeyCode.LeftControl && value != KeyCode.RightControl)
				{
					result.Key = value;
					break;
				}
