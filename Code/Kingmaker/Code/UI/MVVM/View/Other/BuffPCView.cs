...
public class BuffPCView : ViewBase<BuffVM>, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler
{
	...
	protected override void BindViewImplementation()
	{
		...
		AddDisposable(this.SetTooltip(new TooltipTemplateBuff(base.ViewModel.Buff, base.ViewModel.AdditionalSources), new TooltipConfig(InfoCallPCMethod.RightMouseButton, InfoCallConsoleMethod.None)));
	}
