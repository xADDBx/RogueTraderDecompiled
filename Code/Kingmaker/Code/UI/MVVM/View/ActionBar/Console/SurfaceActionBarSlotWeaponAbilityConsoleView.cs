...
public class SurfaceActionBarSlotWeaponAbilityConsoleView : SurfaceActionBarSlotWeaponAbilityView, IConsoleNavigationEntity, IConsoleEntity, IConfirmClickHandler, IHasTooltipTemplate
{
	[Header("ConsoleSlot")]
	[SerializeField]
