...
public class TooltipBrickTitleWithIconConsoleView : TooltipBrickTitleWithIconView, IConsoleTooltipBrick, IConsoleNavigationEntity, IConsoleEntity, IHasTooltipTemplate, IMonoBehaviour
{
	[SerializeField]
