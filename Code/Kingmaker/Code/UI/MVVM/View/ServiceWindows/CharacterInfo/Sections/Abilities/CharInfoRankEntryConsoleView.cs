...
public class CharInfoRankEntryConsoleView : CharInfoFeatureSimpleBaseView, IConsoleNavigationEntity, IConsoleEntity, IHasTooltipTemplate, IConfirmClickHandler
{
	[SerializeField]
