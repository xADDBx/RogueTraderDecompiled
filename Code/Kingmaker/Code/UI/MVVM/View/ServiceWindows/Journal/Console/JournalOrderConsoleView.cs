...
public class JournalOrderConsoleView : BaseJournalItemConsoleView
{
	[Header("Objectives")]
	[SerializeField]
	...
	[SerializeField]
	private JournalOrderRequirementElementConsoleView m_RequirementsViewPrefab;
	...
	[SerializeField]
	private JournalOrderRewardElementConsoleView m_RewardsViewPrefab;
	...
	[SerializeField]
	private JournalOrderResourcesConsoleView m_JournalOrderResourcesConsoleViewPrefab;

	[SerializeField]
	private JournalOrderProfitFactorConsoleView m_JournalOrderProfitFactorConsoleViewPrefab;

	[SerializeField]
	private ConsoleHint m_CompleteOrderHint;

	[SerializeField]
	private float m_DefaultConsoleFontSize = 21f;

	public ConsoleHint CompleteOrderHint => m_CompleteOrderHint;

	public OwlcatButton CompleteOrderButton => m_CompleteOrderButton;
	...
	{
		m_WidgetListResources.DrawEntries(base.ViewModel.ResourcesVMs, m_JournalOrderResourcesConsoleViewPrefab);
		m_JournalOrderProfitFactorConsoleViewPrefab.Bind(base.ViewModel.JournalOrderProfitFactorVM);
	}

	public bool IsOrderCompleted()
	{
		return !base.ViewModel.IsOrderCompleted.Value;
	}
