...
public class UIStrings : StringsContainer
{
	...
	public UITextGlobalMap GlobalMap;

	public UITextSystemMap SystemMap;

	public UITextGlobalMapPassages GlobalMapPassages;
	...
	public UISpaceCombatTexts SpaceCombatTexts;

	public UIExplorationTexts ExplorationTexts;

	public UIColonizationTexts ColonizationTexts;

	public UIColonyProjectsTexts ColonyProjectsTexts;

	public UIColonyProjectsRewards ColonyProjectsRewards;

	public UIColonyProjectsRequirements ColonyProjectsRequirements;

	public UIColonyNotificationTexts ColonyNotificationTexts;

	public UIColonyEventsTexts ColonyEventsTexts;

	public UIColonyTraitsTexts ColonyTraitsTexts;
	...
	public UIShipCustomization ShipCustomization;
	...
	public UIAbilityTexts AbilityTexts;

	public UICargoTexts CargoTexts;
