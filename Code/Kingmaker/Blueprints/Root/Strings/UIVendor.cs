...
public class UIVendor
{
	...
	public LocalizedString CargoCompartment;

	public LocalizedString UnsupportedItem;

	public LocalizedString RelationshipLevel;

	public LocalizedString PointsToNextLevel;

	public LocalizedString ProceedTransaction;

	public LocalizedString DemandCargo;
	...
	public LocalizedString CargoSelectingMenu;

	public LocalizedString NoValidCargos;

	public LocalizedString Discount;

	public LocalizedString CantSelectCargoForSell;
