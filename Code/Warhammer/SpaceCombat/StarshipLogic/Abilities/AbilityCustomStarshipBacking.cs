...
[TypeId("a828459e4ab8e3948a702181cdcd354a")]
public class AbilityCustomStarshipBacking : AbilityCustomLogic, ICustomShipPathProvider, IAbilityTargetRestriction
{
	[SerializeField]
	...
	public Dictionary<GraphNode, CustomPathNode> GetCustomPath(StarshipEntity starship, Vector3 pos, Vector3 dir)
	{
		...
		int direction = CustomGraphHelper.GuessDirection(-1f * dir);
		_ = starship.Blueprint.Inertia;
		AddLine(CustomGraphHelper.OppositeDirections[CustomGraphHelper.OppositeDirections[direction]], 4);
