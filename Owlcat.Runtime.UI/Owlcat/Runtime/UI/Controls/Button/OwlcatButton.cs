...
public class OwlcatButton : OwlcatSelectable, IConfirmClickHandler, IConsoleEntity, ILongConfirmClickHandler, IDeclineClickHandler, ILongDeclineClickHandler, IFunc01ClickHandler, ILongFunc01ClickHandler, IFunc02ClickHandler, ILongFunc02ClickHandler, IPointerClickHandler, IEventSystemHandler, IConsolePointerLeftClickEvent, IConsoleNavigationEntity
{
	...
	{
		return m_ConfirmClickEvent.AllListenersCount > 0;
	}
	...
	{
		return m_LongConfirmClickEvent.AllListenersCount > 0;
	}
	...
	{
		return m_DeclineClickEvent.AllListenersCount > 0;
	}
	...
	{
		return m_LongDeclineClickEvent.AllListenersCount > 0;
	}
	...
	{
		return m_Func01ClickEvent.AllListenersCount > 0;
	}
	...
	{
		return m_LongFunc01ClickEvent.AllListenersCount > 0;
	}
	...
	{
		return m_Func02ClickEvent.AllListenersCount > 0;
	}
	...
	{
		return m_LongFunc02ClickEvent.AllListenersCount > 0;
	}
