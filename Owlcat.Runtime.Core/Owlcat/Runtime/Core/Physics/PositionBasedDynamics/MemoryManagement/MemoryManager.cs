...
internal class MemoryManager
{
	...
	private void SetGpuBodyData(int bodyDescriptorIndex, ref BodyDescriptor bodyDesc, bool isSkinned)
	{
		...
		GpuData.ParticlesSoA.BasePositionBuffer.SetData(ParticlesSoA.BasePosition, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.y);
		GpuData.ParticlesSoA.PositionBuffer.SetData(ParticlesSoA.Position, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.y);
		GpuData.ParticlesSoA.PredictedBuffer.SetData(ParticlesSoA.Predicted, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.y);
		GpuData.ParticlesSoA.VelocityBuffer.SetData(ParticlesSoA.Velocity, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.y);
		GpuData.ParticlesSoA.MassBuffer.SetData(ParticlesSoA.Mass, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.y);
		GpuData.ParticlesSoA.RadiusBuffer.SetData(ParticlesSoA.Radius, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.y);
		GpuData.ParticlesSoA.FlagsBuffer.SetData(ParticlesSoA.Flags, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.x, bodyDesc.ParticlesOffsetCount.y);
		GpuData.ConstraintsSoA.Index0Buffer.SetData(ConstraintsSoA.Index0, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.y);
		GpuData.ConstraintsSoA.Index1Buffer.SetData(ConstraintsSoA.Index1, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.y);
		GpuData.ConstraintsSoA.Index2Buffer.SetData(ConstraintsSoA.Index2, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.y);
		GpuData.ConstraintsSoA.Index3Buffer.SetData(ConstraintsSoA.Index3, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.y);
		GpuData.ConstraintsSoA.Parameters0Buffer.SetData(ConstraintsSoA.Parameters0, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.y);
		GpuData.ConstraintsSoA.Parameters1Buffer.SetData(ConstraintsSoA.Parameters1, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.y);
		GpuData.ConstraintsSoA.TypeBuffer.SetData(ConstraintsSoA.Type, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.x, bodyDesc.ConstraintsOffsetCount.y);
	...
	private void CopyAllBodiesDataOnGpu()
	{
		...
		GpuData.ParticlesSoA.BasePositionBuffer.SetData(ParticlesSoA.BasePosition, 0, 0, ParticlesCount);
		GpuData.ParticlesSoA.PositionBuffer.SetData(ParticlesSoA.Position, 0, 0, ParticlesCount);
		GpuData.ParticlesSoA.PredictedBuffer.SetData(ParticlesSoA.Predicted, 0, 0, ParticlesCount);
		GpuData.ParticlesSoA.VelocityBuffer.SetData(ParticlesSoA.Velocity, 0, 0, ParticlesCount);
		GpuData.ParticlesSoA.MassBuffer.SetData(ParticlesSoA.Mass, 0, 0, ParticlesCount);
		GpuData.ParticlesSoA.RadiusBuffer.SetData(ParticlesSoA.Radius, 0, 0, ParticlesCount);
		GpuData.ParticlesSoA.FlagsBuffer.SetData(ParticlesSoA.Flags, 0, 0, ParticlesCount);
		GpuData.ConstraintsSoA.Index0Buffer.SetData(ConstraintsSoA.Index0, 0, 0, ConstraintsCount);
		GpuData.ConstraintsSoA.Index1Buffer.SetData(ConstraintsSoA.Index1, 0, 0, ConstraintsCount);
		GpuData.ConstraintsSoA.Index2Buffer.SetData(ConstraintsSoA.Index2, 0, 0, ConstraintsCount);
		GpuData.ConstraintsSoA.Index3Buffer.SetData(ConstraintsSoA.Index3, 0, 0, ConstraintsCount);
		GpuData.ConstraintsSoA.Parameters0Buffer.SetData(ConstraintsSoA.Parameters0, 0, 0, ConstraintsCount);
		GpuData.ConstraintsSoA.Parameters1Buffer.SetData(ConstraintsSoA.Parameters1, 0, 0, ConstraintsCount);
		GpuData.ConstraintsSoA.TypeBuffer.SetData(ConstraintsSoA.Type, 0, 0, ConstraintsCount);
