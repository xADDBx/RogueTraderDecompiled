...
public class DxtCompressorService : IService
{
	...
	public class Request
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal unsafe delegate void Compress_00000E15_0024PostfixBurstDelegate(int width, int height, byte* inData, byte* outData, bool hasAlpha);

		internal static class Compress_00000E15_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = BurstCompiler.CompileFunctionPointer<Compress_00000E15_0024PostfixBurstDelegate>(Compress).Value;
				}
				P_0 = Pointer;
			}
		...
		{
			Compress_00000E15_0024BurstDirectCall.Invoke(width, height, inData, outData, hasAlpha);
		}
