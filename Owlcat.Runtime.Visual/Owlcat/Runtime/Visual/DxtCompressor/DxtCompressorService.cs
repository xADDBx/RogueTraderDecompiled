...
public class DxtCompressorService : IService
{
	...
	public class Request
	{
		...
		public unsafe delegate void Compress_00000E08_0024PostfixBurstDelegate(int width, int height, byte* inData, byte* outData, bool hasAlpha);

		internal static class Compress_00000E08_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Compress_00000E08_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static Compress_00000E08_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		{
			Compress_00000E08_0024BurstDirectCall.Invoke(width, height, inData, outData, hasAlpha);
		}
