...
public class BeforeTransparentPostProcessPass : ScriptableRenderPass
{
	...
	protected override void RecordRenderGraph(ref RenderingData renderingData)
	{
		...
		renderGraph.BeginProfilingSampler(sampler, ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\Passes\\PostProcess\\BeforeTransparentPostProcessPass.cs", 99);
		...
		RenderGraphBuilder renderGraphBuilder = renderGraph.AddRenderPass<PostProcessPassDataBase>("RenderBeforeTransparentPostProcess.FinalBlit", out passData2, ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\Passes\\PostProcess\\BeforeTransparentPostProcessPass.cs", 139);
		try
		{
		...
		renderGraph.EndProfilingSampler(sampler, ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\Passes\\PostProcess\\BeforeTransparentPostProcessPass.cs", 156);
	...
	private void DoSSCS(ref RenderingData renderingData, TextureHandle source, TextureHandle destination)
	{
		...
		using RenderGraphBuilder renderGraphBuilder = renderingData.RenderGraph.AddRenderPass<SSCSPassData>("RenderBeforeTransparentPostProcess.SSCS", out passData2, ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\Passes\\PostProcess\\BeforeTransparentPostProcessPass.cs", 180);
