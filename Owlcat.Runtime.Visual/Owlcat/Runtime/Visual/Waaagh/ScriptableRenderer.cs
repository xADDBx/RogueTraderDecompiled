...
public abstract class ScriptableRenderer : IDisposable
{
	...
	public void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
	{
		...
		renderGraph.BeginProfilingSampler(TryGetOrAddCameraSampler(camera), ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\ScriptableRenderer.cs", 264);
		...
		m_ActiveRenderPassQueue.Clear();
		renderGraph.EndProfilingSampler(TryGetOrAddCameraSampler(camera), ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\ScriptableRenderer.cs", 281);
