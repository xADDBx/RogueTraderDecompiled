...
public static class FogOfWarConstantBuffer
{
	...
	public static int _FogOfWarHistoryCopyMap = Shader.PropertyToID("_FogOfWarHistoryCopyMap");

	public static int _FogOfWarRevealOnStart = Shader.PropertyToID("_FogOfWarRevealOnStart");
