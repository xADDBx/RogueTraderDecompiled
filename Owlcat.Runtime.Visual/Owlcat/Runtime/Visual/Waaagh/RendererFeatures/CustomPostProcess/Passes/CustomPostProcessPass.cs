...
public class CustomPostProcessPass : ScriptableRenderPass
{
	...
	protected override void RecordRenderGraph(ref RenderingData renderingData)
	{
		...
		renderGraph.BeginProfilingSampler(m_ProfilingSampler, ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\RendererFeatures\\CustomPostProcess\\Passes\\CustomPostProcessPass.cs", 86);
		...
		for (int i = 0; i < m_Effects.Count; i++)
		{
			...
			renderGraph.BeginProfilingSampler(m_EffectsProfilingSamplers[i], ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\RendererFeatures\\CustomPostProcess\\Passes\\CustomPostProcessPass.cs", 121);
			for (int j = 0; j < customPostProcessEffect.Passes.Count; j++)
			{
				...
				RenderGraphBuilder renderGraphBuilder = renderGraph.AddRenderPass<CustomPostProcessPassData>(customPostProcessEffectPass.Name, out passData2, ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\RendererFeatures\\CustomPostProcess\\Passes\\CustomPostProcessPass.cs", 131);
				try
				{
			...
			renderGraph.EndProfilingSampler(m_EffectsProfilingSamplers[i], ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\RendererFeatures\\CustomPostProcess\\Passes\\CustomPostProcessPass.cs", 157);
		}
		CustomPostProcessPassData passData3;
		RenderGraphBuilder renderGraphBuilder2 = renderGraph.AddRenderPass<CustomPostProcessPassData>("Final Blit", out passData3, ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\RendererFeatures\\CustomPostProcess\\Passes\\CustomPostProcessPass.cs", 161);
		try
		{
		...
		renderGraph.EndProfilingSampler(m_ProfilingSampler, ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Waaagh\\RendererFeatures\\CustomPostProcess\\Passes\\CustomPostProcessPass.cs", 178);
