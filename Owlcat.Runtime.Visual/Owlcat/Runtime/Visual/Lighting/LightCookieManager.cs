...
public class LightCookieManager : IDisposable
{
	...
	private sealed class LightCookiePass : ScriptableRenderPass
	{
		...
		{
			PassData passData;
			using RenderGraphBuilder renderGraphBuilder = renderingData.RenderGraph.AddRenderPass<PassData>(Name, out passData, ".\\Library\\PackageCache\\com.owlcat.visual@5bdd4ffebc6c\\Runtime\\Lighting\\LightCookieManager.cs", 406);
